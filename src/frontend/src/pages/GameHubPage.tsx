      ...
      <section className="hero-panel" aria-labelledby="hero-title">
        <div className="hero-copy">
          ...
          <p className="hero-summary">
            Sprint 2 puts the playable hub first, keeps anonymous play obvious, and loads each
            game from a shared manifest.
          </p>
        </div>

        <ul className="hero-highlights" aria-label="Platform highlights">
          <li>Play instantly as a guest</li>
          <li>Use your account for scores and multiplayer</li>
          <li>Keep every game contract in one shared manifest</li>
        </ul>
      </section>
